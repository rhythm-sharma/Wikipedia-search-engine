...
const Card = (props) => {
    ...
    return(
      <div className="center grow mw5 mw6-ns">
          <article className="grow center mw5 mw6-ns p2 wrapper hidden  b--black-10 mv4" data-aos="fade-up">
          <h1 className="f4 bg-near-white black-60 mv0 pv2 ph3">
              <a className="black no-underline underline-hover" href={directLink} target="blank">{props.title}</a>
          </h1>
